...
public class Test {
	...
	addTest1.setSize(3, 3);
        ...
        addTest1.addElement(0, 1, 0);
        addTest1.addElement(1, 0, 1);
        addTest1.addElement(1, 1, 0);
        addTest1.addElement(2, 0, 1);
    ...
    addTest2.addElement(0, 1, 0);
    addTest2.addElement(1, 0, -1);
    addTest2.addElement(1, 1, 0);
    addTest2.addElement(2, 0, -1);
    addTest2.addElement(2, 2, -3);
       ...
       SparseInterface addTest3 = addTest1.addMatrices(addTest2);
        ...
        multiplyTest1.addElement(1, 0, 1);
        multiplyTest1.addElement(2, 0, 1);
        
        multiplyTest1.addElement(1, 1, 1);
        multiplyTest1.addElement(2, 1, 1);
        
        multiplyTest1.addElement(1, 2, 1);
        multiplyTest1.addElement(2, 2, 1);

        SparseInterface multiplyTest2 = new SparseMatrix();
        multiplyTest2.setSize(3,4 );
